...
this.wwd.navigator.lookAtLocation.latitude = latitude_js; // lat fatec: -23.2903
this.wwd.navigator.lookAtLocation.longitude = longitude_js; // long fatec: -47.2963
this.wwd.navigator.range = 5e3; // 2 million meters above the ellipsoid
...
this.wwd.redraw();
  ...
  // CrosshairLayer
  globe.addLayer(new WorldWind.CrosshairLayer(), {
    category: "setting",
    enabled: true
  });
