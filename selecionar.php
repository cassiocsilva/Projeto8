...
<body>
	...
	<div>
		<div class="barra-titulo">Acesso aos dados armazenados</div>
	</div>
	
	<div class="info_p8">
		<div>
			Nesta página, o usuário poderá acessar os dados armazenados no Banco de Dados do Projeto.</br>
                        Utilize a caixa de seleção abaixo, para visualização da localização no mapa.</br>
		</div>
	</div>
		...
		<div>
                        <form action="./visualizar.php" method="post">
                                ...
                                Selecionar rastreamento: 
                                
                                <select name="select_rastreamento">
...
<?php
   ...
   $query_rastreamento = "SELECT * FROM posicao";
                                
   $res_rastreamento = mysqli_query ($conn, $query_rastreamento);
                                
   while ($row_rastreamento = mysqli_fetch_assoc($res_rastreamento)) { ?>
      <option value="<?php echo $row_rastreamento['id_pos']; ?>">
      <?php echo $row_rastreamento['timestamp']; ?>
      </option> <?php  
   }                                
?>  
	...
	<div class="barra-mapa">
		<img src="img/vgPro8_selecionar.png" width="193" height="324" >
	</div>
